...
test('phone number test is correct', () => {
    expect(functions.isPhoneNumber('858-333-3456')).toBe(true);
}); 

test('phone number test is correct', () => {
    expect(functions.isPhoneNumber('123-456-8900')).toBe(true);
});  

test('phone number test is incorrect', () => {
    expect(functions.isPhoneNumber('12-3456-789')).toBe(false);
}); 
